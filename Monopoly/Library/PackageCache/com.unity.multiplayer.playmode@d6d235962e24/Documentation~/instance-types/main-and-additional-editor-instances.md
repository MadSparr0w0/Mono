...
Multiplayer Play Mode streamlines local multiplayer testing by utilizing an Editor instance alongside one or more
additional Editor instances.
...
* Select the **Focus on Player** icon in the Play Mode Status Window pertaining to that instance.
* Use the focus player keyboard shortcuts.

### Focusing on an additional Editor through the Play Mode Status Window

1. Open the Play Mode Status Window.
...
1. Focus on the Editor you want to configure from within the Play Mode Status Window.
