...
![Play Mode dropdown menu](../images/scenario-dropdown.png)

To create a Play Mode Scenario:

1. Open the Play Mode Scenarios window from **Window** > **Multiplayer** > **Play Mode Scenarios** or select the Play Mode dropdown menu.
