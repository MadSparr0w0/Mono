...
You can change the running mode to manual control using the Play Mode Status window (**Window** > **Multiplayer** >
**Play Mode Status**). To launch an instance independently, either press **Activate** for Editor instances or **Run** 
for local instances.

> [!NOTE]
> Manually controlled instances are still part of the scenario and still appear in the Play Mode Status window. If the streaming log option is enabled, logs are still displayed in the console of the main Editor.
